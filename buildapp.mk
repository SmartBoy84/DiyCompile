...
SWIFTC := $(ROOT)/toolchain/bin/swiftc

CDEBUG := -ggdb -O0 # off by default
COPTIMIZE := -Os
CDIAGNOSTICS := -Xfrontend -fcolor-diagnostics -DTARGET_IPHONE=1 -Wall -Wno-unused-command-line-argument -Qunused-arguments -Werror
